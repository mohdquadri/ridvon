...
export function KeyMetricsCard({
  ...
  const items: MetricItem[] = [
    ...
    item("Insider Own", formatMarginPct(f?.insiderOwnPct ?? null)),
    item("Inst Own", formatMarginPct(f?.instOwnPct ?? null)),
    item("Insider Trans (6M)", formatMarginPct(f?.insiderTransPct ?? null)),
    item("Inst Trans (Qtr)", formatMarginPct(f?.instTransPct ?? null)),
    item("Short Float", formatMarginPct(f?.shortFloatPct ?? null)),
